...
import { useFurnisherSettingsStore, DataProviderTypeSetting, EntityStatusSetting, EntityTypeSetting } from '../../../store/furnisherSettingsStore';

interface SettingsModalProps {
  onClose: () => void;
}

type SettingsCategory = 'data-types' | 'statuses' | 'entity-types';
...
export default function SettingsModal({ onClose }: SettingsModalProps) {
  ...
  const [activeCategory, setActiveCategory] = useState<SettingsCategory>('data-types');
